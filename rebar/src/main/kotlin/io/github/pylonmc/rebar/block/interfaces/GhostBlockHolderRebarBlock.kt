...
/**
 * A wrapper over [EntityHolderRebarBlock] which allows for 'ghost blocks' (like those used
...
interface GhostBlockHolderRebarBlock : EntityHolderRebarBlock {
    ...
    class GhostBlockHitbox : RebarEntity<Interaction>, InteractRebarEntityHandler, DamageRebarEntityHandler {
        ...
        override fun onDamaged(event: EntityDamageEvent, priority: EventPriority) {
    ...
    companion object : Listener {
        ...
        fun onLoad(event: RebarBlockLoadEvent) {
            ...
            if (block !is GhostBlockHolderRebarBlock) {
                return
            }
